...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settings.syntax_highlighting'
        db.add_column('questions_settings', 'syntax_highlighting',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Settings.syntax_highlighting'
        db.delete_column('questions_settings', 'syntax_highlighting')
